...
public class MiniJavaIDE {
    ...
    private static JPanel createTabHeader(JFrame frame, JTabbedPane tabbedPane, String className, JTextArea area) {
    ...
    private static void saveJavaFile(JFrame frame, String className, JTextArea area) {
        ...
        try {
            ...
            showToast(frame, "已經完成修改");

        } catch (IOException ex) {

            showToast(frame, "修改失敗: " + ex.getMessage());
    ...
    private static void openOrUpdateTab(
        ...
        if (editorMap.containsKey(className)) {
            ...
            tabbedPane.setTabComponentAt(
                    ...
                    createTabHeader(frame, tabbedPane, className, area)
            );
